...
import '../controller/parent_onboarding_controller.dart';

class ParentOnBoardingScreen extends ParentWidget {
  const ParentOnBoardingScreen({super.key});

  @override
  Widget buildingView(BuildContext context, double h, double w) {
    ParentOnBoardingController controller = Get.put(ParentOnBoardingController());
    return Obx(() => Container(
        ...
        child: Stack(
          children: [
            ...
            backButton(
              () => controller.currentIndex.value == 0 ? Navigator.pop(context) : controller.currentIndex.value--,
            ),
            Align(
