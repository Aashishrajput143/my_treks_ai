...
import '../controller/mentor_signup_controller.dart';

class MentorSignUpScreen extends ParentWidget {
  const MentorSignUpScreen({super.key});

  @override
  Widget buildingView(BuildContext context, double h, double w) {
    MentorSignUpController controller = Get.put(MentorSignUpController());
    return SizedBox(
        height: h,
        width: w,
        child: Stack(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 20),
                      commonButton(double.infinity, 50, appColors.contentAccent,  Colors.white,hint:appStrings.signUpButton , () {
                        Get.toNamed(RoutesClass.signUpDetails,arguments: "MENTOR");
                      }),
